        ...
        <div class="row grid">
            ...
            <div class="col-md-12 grid-item table">
                <div class="admin-table">
                    <div class="adminComponentHeading"><h3>Product Table</h3>
                    </div>
                    <table cellpadding="8">
                        <tr>
                            <th>Sr. No.</th>
            ...
            <div class="col-md-12 grid-item addform">
                <div class="admin-form">
                    <div class="adminComponentHeading"><h3>Product Form</h3>
                    </div>
                    <form method="post">
            ...
            <div class="col-md-12 grid-item removeform">
                <div class="admin-form">
                    <div class="adminComponentHeading"><h3>Remove Product Form</h3>
                    </div>
                    <form method="post">
